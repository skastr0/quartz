...
/**
 * Native `evalType` — not yet implemented. Its owning builder replaces this
...
export const evalType =
  (_ctx: NativeCommandContext): TypeAnalyzer["evalType"] =>
  () =>
    Effect.fail(engineNotSupported("evalType"))
