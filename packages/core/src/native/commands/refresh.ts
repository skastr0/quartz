...
/**
 * Native `refresh` — not yet implemented. Its owning builder replaces this
...
export const refresh =
  (_ctx: NativeCommandContext): TypeAnalyzer["refresh"] =>
  () =>
    Effect.fail(engineNotSupported("refresh"))
