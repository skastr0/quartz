...
/**
 * Native `explainType` — not yet implemented. Its owning builder replaces this
...
export const explainType =
  (_ctx: NativeCommandContext): TypeAnalyzer["explainType"] =>
  () =>
    Effect.fail(engineNotSupported("explainType"))
