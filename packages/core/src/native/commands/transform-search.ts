...
/**
 * Native `transformSearch` — not yet implemented. Its owning builder replaces this
...
export const transformSearch =
  (_ctx: NativeCommandContext): TypeAnalyzer["transformSearch"] =>
  () =>
    Effect.fail(engineNotSupported("transformSearch"))
