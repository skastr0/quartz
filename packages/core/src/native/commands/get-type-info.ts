...
/**
 * Native `getTypeInfo` — not yet implemented. Its owning builder replaces this
...
export const getTypeInfo =
  (_ctx: NativeCommandContext): TypeAnalyzer["getTypeInfo"] =>
  () =>
    Effect.fail(engineNotSupported("getTypeInfo"))
